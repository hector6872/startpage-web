...
const translations = {
  ...
  it: {
    ...
    "todo-placeholder": "Aggiungi un'attività...",
    "countdown-placeholder": "Titolo evento...",
    ...
    "color-black": "Nero / Onice",
    "label-theme": "Aspetto",
    "theme-system": "Predefinito di Sistema",
    "theme-light": "Chiaro",
    "theme-dark": "Scuro",
    "label-world-clock-tz": "Fuso Orario Secondario",
    "label-world-clock-label": "Etichetta Orologio",
    "world-clock-sub": "Orologio Mondiale",
    ...
    "wiki-type-quote": "Citazione del Giorno",
    "wiki-type-topread": "Articoli Più Letti",
    "wiki-type-news": "Notizie",
    "wiki-type-onthisday": "Accadde Oggi",
    ...
    "wiki-refresh": "Prossima Citazione",
    "label-show-google-tasks-title": "Google Tasks",
    "label-show-google-tasks-today": "Attività di Oggi",
    "label-show-google-tasks-week": "Prossime Attività (Settimana)",
    "label-show-google-tasks-overdue": "Includi Scadute",
    "label-city": "Località Meteo",
    "label-weather-url": "URL Meteo Web",
    "weather-url-placeholder": "es. https://ilmeteo.it o lascia vuoto",
    "label-world-clock-url": "URL Orologio Web",
    "clock-url-placeholder": "es. https://time.is o lascia vuoto",
    "label-finance-url": "URL Mercati / Finanza",
    "finance-url-placeholder": "es. https://www.google.com/finance",
    "label-timer-url": "URL Timer",
    "timer-url-placeholder": "es. https://www.google.com/search?q=timer",
    "label-stopwatch-url": "URL Cronometro",
    "stopwatch-url-placeholder": "es. https://www.google.com/search?q=stopwatch",
    ...
    "city-desc": "Lascia vuoto per la geolocalizzazione automatica.",
    "google-desc": "Collega le tue credenziali Google Cloud per sincronizzare Calendario, Tasks e Gmail Prioritaria.",
    ...
    "label-gitlab-token": "Personal Access Token (PAT)",
    "jira-cors-warning": "Nota: L'API di Jira richiede autorizzazione CORS. Utilizza un'estensione browser in locale.",
  ...
  ja: {
    ...
    "color-teal": "ティール",
    "color-slate": "スレートグレー",
    "color-black": "ブラック / オニキス",
    "label-theme": "テーマ",
    "theme-system": "システム設定に従う",
    "theme-light": "ライト",
    "theme-dark": "ダーク",
    "label-world-clock-tz": "セカンドタイムゾーン",
    "label-world-clock-label": "時計ラベル",
    ...
    "label-show-wikipedia": "Wikipedia",
    "label-wikipedia-type": "コンテンツタイプ",
    "wiki-type-quote": "今日の名言",
    "wiki-type-topread": "注目の記事",
    "wiki-type-news": "ニュース",
    ...
    "label-show-google-tasks-week": "今週のタスク",
    "label-show-google-tasks-overdue": "期限切れタスクを表示",
    "label-city": "天気の地域",
    "label-weather-url": "天気ウェブ URL",
    "weather-url-placeholder": "例: https://weathernews.jp または空欄",
    "label-world-clock-url": "時計ウェブ URL",
    "clock-url-placeholder": "例: https://time.is または空欄",
    "label-finance-url": "株価・マーケット URL",
    "finance-url-placeholder": "例: https://www.google.com/finance",
    "label-timer-url": "タイマー URL",
    "timer-url-placeholder": "例: https://www.google.com/search?q=timer",
    "label-stopwatch-url": "ストップウォッチ URL",
    "stopwatch-url-placeholder": "例: https://www.google.com/search?q=stopwatch",
    "notes-btn-title": "メモ帳",
    ...
    "city-desc": "空欄にするとブラウザの位置情報を自動取得します。",
    ...
    "google-status-personal": "個人アカウント:",
    "google-status-work": "仕事アカウント:",
    "google-color": "バッジカラー:",
    "badge-personal": "個人",
    "badge-work": "仕事",
    ...
    "label-gitlab-token": "Personal Access Token (PAT)",
    "jira-cors-warning": "注意: Jira API のローカル呼び出しには CORS 拡張機能が必要です。",
...
const quotesDb = {
  ...
  ca: [
    { text: "L'única manera de fer una gran feina és estimar el que fas.", author: "Steve Jobs" },
    { text: "La simplicitat és la màxima sofisticació.", author: "Leonardo da Vinci" },
    { text: "Fes-ho simple, però significatiu.", author: "Don Draper" }
  ],
  fr: [
  ...
  de: [
    ...
    { text: "Besser fertig als perfekt.", author: "Sheryl Sandberg" }
  ],
  it: [
    { text: "L'unico modo per fare un ottimo lavoro è amare quello che fai.", author: "Steve Jobs" },
    { text: "La semplicità è l'estrema sofisticazione.", author: "Leonardo da Vinci" },
    { text: "Fatto è meglio che perfetto.", author: "Sheryl Sandberg" }
  ],
  pt: [
  ...
  nl: [
    { text: "De enige manier om geweldig werk te leveren, is houden van wat je doet.", author: "Steve Jobs" },
    { text: "Eenvoud is de ultieme verfijning.", author: "Leonardo da Vinci" },
    { text: "Gedaan is beter dan perfect.", author: "Sheryl Sandberg" }
  ],
  ja: [
    { text: "すばらしい仕事をする唯一の方法は、自分の仕事を愛することだ。", author: "スティーブ・ジョブズ" },
    { text: "シンプルさは究極の洗練である。", author: "レオナルド・ダ・ヴィンチ" },
    { text: "完璧を目指すより、まず終わらせろ。", author: "シェリル・サンドバーグ" }
  ],
  zh: [
    { text: "做出伟大工作的唯一途径就是热爱你所做的事。", author: "史蒂夫·乔布斯" },
    { text: "至繁归于至简。", author: "列奥纳多·达·芬奇" },
